...
describe('GET /todos', () => {
  it('should get all the todos from user1', (done) => {
    request(app)
      .get('/todos')
      .set('x-auth', users[0].tokens[0].token)
      .expect(200)
...
describe('GET /tods/:id', () => {
  ...
  it('should not get the todo from another user', (done) => {
    request(app)
...
describe('DELETE /todos/:id', () => {
  ...
  it('should not remove the todo from another user', (done) => {
    request(app)
      .delete(`/todos/${todos[0]._id.toHexString()}`)
...
describe('PATCH /todos/:id', () => {
  ...
  it('should not update the todo 2', (done) => {
    var firstId = todos[1]._id.toHexString();
    var body = {
      text: "something new",
      completed: false
...
describe('POST /users/login', () => {
  it('should login in a user with correct crential', (done) => {
...
describe('DELETE /users/me/token', () => {
  it('should delete a token on logout', (done) => {
    request(app)
